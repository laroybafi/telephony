                ...
                <div class="col-12">
                    <div class="card card-md">
                        ...
                        <div class="card-body">
                            <div class="row align-items-center">
                                <div class="col-10">
                                    <h3 class="h1">Telephony</h3>
                                    <div class="markdown text-muted">
                                        Lorem ipsum dolor sit amet consectetur adipisicing elit. Distinctio suscipit
                                        dolores animi eos possimus fugit id fuga sunt corporis in necessitatibus totam
                                        ad nam, debitis illum a laudantium molestias ipsam?
                                    </div>
                                    <div class="mt-3">
                                        <a href="#" class="btn btn-primary" rel="noopener">Dashboard</a>
                                    </div>
                                </div>
                            </div>
                        </div>
