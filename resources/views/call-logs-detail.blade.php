                        ...
                        <div class="col-12">
                            <div class="card-body">
                                ...
                                <div class="row row-cards">
                                    <div class="col">
                                        <div class="row mb-3">
                                            <label class="col-4 col-form-label">SID</label>
                                            <div class="col">
                                                <input type="sid" class="form-control" name="sid"
                                                    value="{{ $calls->sid }}" disabled>
                                            </div>
                                        </div>
                                        <div class="row mb-3">
                                        ...
                                        <div class="row mb-3">
                                            <label class="col-4 col-form-label">Date Updated</label>
                                            <div class="col">
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col">
                                                <input type="text" class="form-control" name="duration"
                                                    value="{{ $calls->duration }}" disabled>
                                            </div>
                                        </div>
                                        <div class="row mb-3">
                                            <label class="col-4 col-form-label">Feedback</label>
                                            <div class="col">
                                        ...
                                        <div class="row mb-3">
                                            <label class="col-4 col-form-label">User Defined Messages</label>
                                            <div class="col">
                                        ...
                                        <div class="row mb-3">
                                            <label class="col-4 col-form-label">Notifications</label>
                                            <div class="col">
                                        ...
                                        <div class="row mb-3">
                                            <label class="col-4 col-form-label">Recordings</label>
                                            <div class="col">
                                        ...
                                        <div class="row mb-3">
                                            <label class="col-4 col-form-label">Streams</label>
                                            <div class="col">
